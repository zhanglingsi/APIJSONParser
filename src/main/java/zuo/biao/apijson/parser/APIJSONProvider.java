 ...
 * @author zhangls
 */
public class APIJSONProvider extends BaseProvider {
    ...
    @Getter @Setter
    private List<String> tableWhiteList = Lists.newArrayList();
    @Getter @Setter
    private List<String> tableBlackList = Lists.newArrayList();
    @Getter @Setter
    private List<String> columnWhiteList = Lists.newArrayList();
    @Getter @Setter
    private List<String> columnBlackList = Lists.newArrayList();
